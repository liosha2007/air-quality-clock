...
/**
 * WAKE pin should be pulled down with resistor 10k to communicate with the sensor
 */
...
#define ERR_IC_VERSION    -2      //chip version mismatch
     ...
     */
    Keyestudio_CCS811(TwoWire *pWire = &Wire, uint8_t deviceAddr = 0x5A){_pWire = pWire; _deviceAddr = deviceAddr;};
